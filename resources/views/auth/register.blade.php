                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @error('password')
                                        <span class="text-danger">Informe a sua senha.</span>
                                        @enderror
                                    </div>
                                    <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Cadastrar</button>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">Já tem uma conta?</p>
                                        <a class="text-primary fw-bold ms-2" href="{{ route('login') }}">Entrar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
